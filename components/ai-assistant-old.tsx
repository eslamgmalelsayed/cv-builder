...
const translations = {
  en: {
    ...
    messagePlaceholder: "Ask me anything about your CV, career advice, or job search...",
    send: "Send",
    sending: "Sending...",
  ...
  ar: {
    ...
    messagePlaceholder: "اسألني أي شيء عن سيرتك الذاتية أو النصائح المهنية أو البحث عن وظيفة...",
    send: "إرسال",
      ...
      const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "You are a helpful AI assistant specialized in CV writing, career advice, and job search guidance. Provide clear, actionable advice to help users improve their resumes and career prospects."
            },
            ...messages.map(msg => ({
              role: msg.role,
              content: msg.content
